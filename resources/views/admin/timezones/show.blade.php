                ...
                <div class="tab-pane fade show active" id="v-pills-generel" role="tabpanel" aria-labelledby="v-pills-generel-tab">
                    <div class="row">
                        <div class="col-12 mt-2">
                            <div class="card" id="timezone_generel">
                                <div class="card-body">
                                    <h5 class="card-title">
                                    ...
                                    <div class="collapse-container collapse show" id="collapse-role" aria-labelledby="heading-content">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputTimezone" class="col-md-2 col-form-label">Timezone:</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="zone_name" id="inputTimezone" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script type="application/javascript">
        ...
        jQuery.ajax({
            ...
            jQuery.ajax({
                url: restUrl + "/timezones/<?php echo $id;?>",
                method: "GET",
                headers: restHeader
            }).done(function (response, textStatus, jqXHR) {
                $("#inputTimezone").val(response.data.zone_name)
        ...
        $("#saveRole").click(function(){
            ...
            var formdata = $("#timezone_generel").find("input,select").serializeArray();
